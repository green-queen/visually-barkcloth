  ...
  <ul>
    ...
    <main class="page">
        ...
        <div class="filter-bar" id="filter-bar">
            ...
            <button class="filter-btn" data-structure="square-concentric-structure">Square Concentric</button>
            <button class="filter-btn" data-structure="square-cross-structure">Square Cross</button>
            <button class="filter-btn" data-structure="grid-structure">Grid</button>
            <button class="filter-btn" data-structure="horizontal-line-structure">Horizontal Lines</button>
            <button class="filter-btn" data-structure="vertical-line-structure">Vertical Lines</button>
        </div>
    ...
    <script>
        ...
        { id: "RV-265-7", origin: "Samoa", structures: ["grid-structure"], link: "https://hdl.handle.net/20.500.11840/598304" },
        ...
        { id: "RV-912-4", origin: "East Polynesian (Polynesia / Hawaii)", structures: ["vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/676213" },
        { id: "RV-3600-7499", origin: "West Papua (Nafri, Sentani)", structures: [], link: "https://hdl.handle.net/20.500.11840/777783" },
        { id: "RV-121-65", origin: "West Papua (Karon)", structures: ["grid-structure", "vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/595932" },
        { id: "RV-2972-2", origin: "West Papua (Karon)", structures: ["vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/757315" },
        { id: "RV-2953-2", origin: "West Papua (Wandamen, probably Karon)", structures: ["vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/754845" },
        { id: "RV-1759-31", origin: "Pebato", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/718435" },
        { id: "RV-03-277", origin: "Toraja", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/828350" },
        { id: "RV-03-2400", origin: "Toraja", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/849873" },
        { id: "RV-776-45", origin: "Toraja", structures: ["square-concentric-structure"], link: "https://hdl.handle.net/20.500.11840/671205" },
        { id: "RV-776-45a", origin: "Toraja", structures: ["square-concentric-structure"], link: "https://hdl.handle.net/20.500.11840/671206" },
        { id: "RV-1232-93", origin: "Toraja", structures: ["square-concentric-structure"], link: "https://hdl.handle.net/20.500.11840/690654" },
        { id: "RV-1372-2", origin: "Toraja (Poso Toraja)", structures: ["square-cross-structure", "grid-structure"], link: "https://hdl.handle.net/20.500.11840/701086" },
        { id: "RV-1232-87", origin: "Toraja", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/690648" },
        { id: "RV-1232-92", origin: "Toraja", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/690653" },
        { id: "RV-1759-27", origin: "Pebato", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/718431" },
        { id: "RV-1232-90", origin: "Toraja", structures: ["square-cross-structure", "grid-structure"], link: "https://hdl.handle.net/20.500.11840/690651" },
        { id: "RV-1926-205", origin: "Toraja (Poso Toraja)", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/724867" },
        { id: "RV-1759-36", origin: "Toraja (Lage)", structures: ["square-concentric-structure", "square-cross-structure"], link: "https://hdl.handle.net/20.500.11840/718440" },
        { id: "RV-1759-38", origin: "Toraja (Lage)", structures: ["square-concentric-structure"], link: "https://hdl.handle.net/20.500.11840/718442" },
        { id: "RV-1926-211", origin: "Toraja (Poso Toraja)", structures: ["square-cross-structure", "grid-structure"], link: "https://hdl.handle.net/20.500.11840/724873" },
        { id: "RV-03-276", origin: "Toraja", structures: ["grid-structure"], link: "https://hdl.handle.net/20.500.11840/828349" },
        { id: "RV-03-2349", origin: "Toraja", structures: ["grid-structure"], link: "https://hdl.handle.net/20.500.11840/849473" },
        { id: "RV-1232-94", origin: "Toraja", structures: ["grid-structure", "vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/690655" },
        { id: "RV-03-2391", origin: "Toraja (Poso Toraja)", structures: ["vertical-line-structure"], link: "https://hdl.handle.net/20.500.11840/849514" },
    ];
