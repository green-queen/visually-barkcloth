    ...
    <div class="home-left">
      ...
      <div class="home-adjust">
        <p class="home-subtitle">
          Digitized barkcloth from Wereldmuseum Leiden (Netherlands)</p> 
        <p class="home-subtitle" id="home-subtitle-2">
          and archival photographs from Världskulturmuseerna (Sweden)
        </p>
